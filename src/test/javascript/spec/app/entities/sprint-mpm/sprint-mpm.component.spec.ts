...
import { SprintMpmComponent } from 'app/entities/sprint-mpm/sprint-mpm.component';
...
describe('Component Tests', () => {
    describe('SprintMpm Management Component', () => {
        let comp: SprintMpmComponent;
        let fixture: ComponentFixture<SprintMpmComponent>;
        let service: SprintMpmService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [CampFireTestModule],
                declarations: [SprintMpmComponent],
                providers: [
                    {
                ...
                .overrideTemplate(SprintMpmComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(SprintMpmComponent);
