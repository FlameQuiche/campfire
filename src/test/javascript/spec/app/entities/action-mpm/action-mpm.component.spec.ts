...
import { ActionMpmComponent } from 'app/entities/action-mpm/action-mpm.component';
...
describe('Component Tests', () => {
    describe('ActionMpm Management Component', () => {
        let comp: ActionMpmComponent;
        let fixture: ComponentFixture<ActionMpmComponent>;
        let service: ActionMpmService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [CampFireTestModule],
                declarations: [ActionMpmComponent],
                providers: [
                    {
                ...
                .overrideTemplate(ActionMpmComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(ActionMpmComponent);
