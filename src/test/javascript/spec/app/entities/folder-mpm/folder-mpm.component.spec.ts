...
import { FolderMpmComponent } from 'app/entities/folder-mpm/folder-mpm.component';
...
describe('Component Tests', () => {
    describe('FolderMpm Management Component', () => {
        let comp: FolderMpmComponent;
        let fixture: ComponentFixture<FolderMpmComponent>;
        let service: FolderMpmService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [CampFireTestModule],
                declarations: [FolderMpmComponent],
                providers: [
                    {
                ...
                .overrideTemplate(FolderMpmComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(FolderMpmComponent);
