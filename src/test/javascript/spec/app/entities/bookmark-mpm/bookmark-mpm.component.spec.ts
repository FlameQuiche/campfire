...
import { BookmarkMpmComponent } from 'app/entities/bookmark-mpm/bookmark-mpm.component';
...
describe('Component Tests', () => {
    describe('BookmarkMpm Management Component', () => {
        let comp: BookmarkMpmComponent;
        let fixture: ComponentFixture<BookmarkMpmComponent>;
        let service: BookmarkMpmService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [CampFireTestModule],
                declarations: [BookmarkMpmComponent],
                providers: [
                    {
                ...
                .overrideTemplate(BookmarkMpmComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(BookmarkMpmComponent);
