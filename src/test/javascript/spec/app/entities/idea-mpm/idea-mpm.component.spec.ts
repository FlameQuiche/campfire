...
import { IdeaMpmComponent } from 'app/entities/idea-mpm/idea-mpm.component';
import { IdeaMpmService } from 'app/entities/idea-mpm/idea-mpm.service';
import { IdeaMpm } from 'app/shared/model/idea-mpm.model';

describe('Component Tests', () => {
    describe('IdeaMpm Management Component', () => {
        let comp: IdeaMpmComponent;
        let fixture: ComponentFixture<IdeaMpmComponent>;
        let service: IdeaMpmService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [CampFireTestModule],
                declarations: [IdeaMpmComponent],
                providers: [
                    {
                ...
                .overrideTemplate(IdeaMpmComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(IdeaMpmComponent);
